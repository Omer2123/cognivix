    ...
    <main className="bg-secondary min-h-screen pt-40 pb-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {sectors.map((s, idx) => (
            <div key={idx} className="bg-accent p-12 rounded-[2.5rem] border border-white/5 hover:border-primary/40 transition-all">
              <h2 className="text-3xl font-black text-darktext uppercase mb-4">{s.title}</h2>
