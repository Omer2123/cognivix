...
export default function SmartCities() {
  return (
    <main className="bg-secondary min-h-screen text-slate-300">
      <section className="pt-40 pb-20 px-6 border-b border-slate-900">
        <div className="max-w-7xl mx-auto">
          <span className="text-primary font-black tracking-[0.4em] uppercase text-xs">Sector: Infrastructure</span>
          <h1 className="text-7xl font-black text-darktext uppercase tracking-tighter mt-4 mb-8">
            Urban <span className="text-primary">Orchestration</span>
          </h1>
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-20">
          <div>
            <h2 className="text-3xl font-black text-darktext uppercase tracking-tight mb-6">Technical Framework</h2>
          ...
          <div className="bg-dark/50 p-12 rounded-3xl border border-slate-800 shadow-2xl">
            <h3 className="text-darktext font-bold mb-6 uppercase tracking-widest text-sm">Deployment Statistics</h3>
            <div className="space-y-8">
              <div>
                <div className="flex justify-between text-[10px] font-black uppercase mb-2"><span>Latency Reduction</span><span>88%</span></div>
                <div className="w-full bg-slate-800 h-2 rounded-full overflow-hidden"><div className="bg-primary h-full w-[88%] shadow-[0_0_10px_#dc2626]"></div></div>
              </div>
              <div>
                <div className="flex justify-between text-[10px] font-black uppercase mb-2"><span>Grid Efficiency</span><span>94%</span></div>
                <div className="w-full bg-slate-800 h-2 rounded-full overflow-hidden"><div className="bg-primary h-full w-[94%] shadow-[0_0_10px_#dc2626]"></div></div>
              </div>
            </div>
          </div>
        </div>
