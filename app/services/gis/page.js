    ...
    <div className="min-h-screen bg-secondary text-darktext pt-32 pb-20 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-slate-500">
          ...
          <span>/</span>
          <span className="text-primary uppercase">GIS & Remote Sensing</span>
        </div>

        {/* Header Section */}
        <div className="mb-16 border-l-4 border-primary pl-6">
          <h1 className="text-4xl md:text-6xl font-black uppercase tracking-tighter mb-4">
            GIS & Remote <span className="text-primary">Sensing</span>
          </h1>
        ...
        <div className="mb-20 rounded-3xl overflow-hidden border border-white/10 bg-base/5 relative h-[300px] md:h-[500px] flex items-center justify-center">
           ...
           <div className="relative z-10 text-center px-6">
              <span className="text-primary font-black uppercase tracking-[0.5em] text-[10px] block mb-4">Tactical Visualization Matrix</span>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          {gisCapabilities.map((cap, index) => (
            <div 
              key={index} 
              className="bg-[#12141a] border border-white/10 p-8 rounded-2xl hover:border-primary/50 transition-all group"
            >
        ...
        <div className="bg-gradient-to-r from-[#1a1d24] to-transparent border border-white/10 p-10 rounded-3xl">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-4">
              <div className="px-4 py-2 rounded-full border border-primary/30 bg-primary/5 text-[10px] font-black uppercase tracking-widest">LiDAR Integration</div>
              <div className="px-4 py-2 rounded-full border border-primary/30 bg-primary/5 text-[10px] font-black uppercase tracking-widest">Multi-Spectral Mapping</div>
              <div className="px-4 py-2 rounded-full border border-primary/30 bg-primary/5 text-[10px] font-black uppercase tracking-widest">Geodetic Surveys</div>
            </div>
          </div>
        </div>
