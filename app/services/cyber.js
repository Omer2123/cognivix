               ...
               <div className="text-center">
                  <div className="inline-block p-4 rounded-full bg-primary/10 mb-4">
                    <div className="w-16 h-16 border-2 border-primary border-dashed rounded-full animate-spin-slow flex items-center justify-center">
                      <span className="text-primary text-2xl font-black underline">CYS</span>
                    </div>
                  </div>
                  <p className="text-[10px] font-black uppercase tracking-[0.4em] text-primary">Tactical Security Ops</p>
               </div>
            </div>
          </div>
        </div>
